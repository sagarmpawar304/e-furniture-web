...
export const ORDER_LIST_REQUEST = 'ORDER_ALL_ORDERS_REQUEST'
export const ORDER_LIST_SUCCESS = 'ORDER_ALL_ORDERS_SUCCESS'
export const ORDER_LIST_FAIL = 'ORDER_ALL_ORDERS_FAIL'
export const ORDER_LIST_RESET = 'ORDER_ALL_ORDERS_RESET'
